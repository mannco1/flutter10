...
func CreateProduct(db *sqlx.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		query := `INSERT INTO Product (name, image, description, rules, age, gamers, game_time, price, stock, color_ind)
				  VALUES (:name, :image, :description, :rules, :age, :gamers, :game_time, :price, :stock, :color_ind) RETURNING product_id`
...
func UpdateProduct(db *sqlx.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		rules = :rules, age = :age, gamers = :gamers, game_time = :game_time, price = :price, stock = :stock, color_ind = :color_ind 
